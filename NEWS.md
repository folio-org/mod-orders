...
### Bug Fixes
* [MODORDERS-1330](https://issues.folio.org/browse/MODORDERS-1330) - Updating receiving piece overwrites data in related item record (Ramsons)
...
### Bug Fixes
* [MODORDERS-1248](https://issues.folio.org/browse/MODORDERS-1248) - Use only invoice lines related to the order to calculate total expended
