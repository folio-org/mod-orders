...
public enum ErrorCodes {
  ...
  ZERO_LOCATION_ELECTRONIC_QTY("zeroLocQtyElectronic", "Electronic location quantity must be specified"),
  ZERO_LOCATION_PHYSICAL_QTY("zeroLocQtyPhysical", "Physical location quantity must be specified"),
  ...
  NON_ZERO_LOCATION_PHYSICAL_QTY("nonZeroLocQtyPhysical", "Physical locations quantity must not be specified"),
  NON_ZERO_LOCATION_ELECTRONIC_QTY("nonZeroLocQtyElectronic", "Electronic locations quantity must not be specified"),
  ...
  ELECTRONIC_COST_QTY_EXCEEDS_LOC("costQtyElectronicExceedsLoc", "Cost's electronic quantity exceeds locations' electronic quantity"),
