...
public enum ErrorCodes {
  ...
  INSTANCE_CONNECTION_UPDATE_ERROR("instanceConnectionUpdateError", "Instance connection could not be changed, the chosen instance contains an invalid Product ID.");
