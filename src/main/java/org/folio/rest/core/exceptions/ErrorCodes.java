...
public enum ErrorCodes {
  ...
  COMPOSITE_ORDER_MISSING_PO_LINES("compositeOrderMissingPoLines", "Composite order is missing poLines for Open operations"),
  ...
  FISCAL_YEAR_DISTRIBUTION_COUNT_MISMATCH("fiscalYearDistributionCountMismatch", "The number of fiscal year distributions must exactly match the prepayment term");
