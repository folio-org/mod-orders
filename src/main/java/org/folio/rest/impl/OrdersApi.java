...
public class OrdersApi extends BaseApi implements OrdersCompositeOrders, OrdersRollover {
  ...
  @Override
  @Validate
  public void putOrdersCompositeOrdersById(String orderId, boolean deleteHoldingAndItems, String lang, CompositePurchaseOrder compPO,
    ...
    purchaseOrderHelper.validateExistingOrder(orderId, compPO, requestContext)
      .compose(validationErrors -> {
        if (CollectionUtils.isEmpty(validationErrors)) {
          return purchaseOrderHelper.updateOrder(compPO, deleteHoldingAndItems, requestContext)
            .onSuccess(v -> {
