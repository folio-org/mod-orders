  ...
  Response buildErrorResponse(int code, String message) {
    ...
    switch (code) {
      case LIMIT_INTERNAL_HTTP_CODE:
        result = PostOrdersResponse.respond422WithApplicationJson(withErrors(message, LINES_LIMIT_ERROR_CODE));
        break;
      case 400:
        result = PostOrdersResponse.respond400WithTextPlain(message);
        break;
      case 401:
        result = PostOrdersResponse.respond401WithTextPlain(message);
        break;
      case 422:
        result = PostOrdersResponse.respond422WithApplicationJson(withErrors(message));
        break;
      default:
        result = PostOrdersResponse.respond500WithTextPlain(message);
    }
    return result;
  }
