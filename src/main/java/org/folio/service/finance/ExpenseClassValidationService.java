...
public class ExpenseClassValidationService {
    ...
    public ExpenseClassValidationService(BudgetExpenseClassService budgetExpenseClassService, ExpenseClassService expenseClassService) {
        this.budgetExpenseClassService = budgetExpenseClassService;
        this.expenseClassService = expenseClassService;
    }

    public CompletableFuture<Void> validateExpenseClassesForOpenedOrder(CompositePurchaseOrder compOrder, List<CompositePoLine> compositePoLines, RequestContext requestContext) {
    ...
    private CompletableFuture<Void> checkExpenseClassIsActiveByFundDistribution(Map.Entry<FundDistribution, String> expenseClassByFundId, RequestContext requestContext) {
    ...
    private CompletableFuture<List<Parameter>> getFundIdExpenseClassIdParameters(Map.Entry<FundDistribution, String> expenseClassByFundId, RequestContext requestContext) {
