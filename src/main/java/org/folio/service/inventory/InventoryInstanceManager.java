...
public class InventoryInstanceManager {
  ...
  public Future<String> getOrCreateInstanceRecord(Title title, boolean isInstanceMatchingDisabled, boolean suppressDiscovery, RequestContext requestContext) {
  ...
  public Future<String> createInstanceRecord(Title title, boolean suppressDiscovery, RequestContext requestContext) {
    ...
    return Future.join(List.of(instanceTypeFuture, statusFuture, contributorNameTypeIdFuture))
  ...
  private Future<String> getInstanceRecordAndShareIfNeeded(PoLine poLine, ConsortiumConfiguration configuration, RequestContext requestContext) {
  ...
  private Future<String> createInstanceRecord(PoLine poLine, RequestContext requestContext) {
    ...
    return Future.join(instanceTypeFuture, statusFuture, contributorNameTypeIdFuture)
