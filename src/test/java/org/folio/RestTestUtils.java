...
public class RestTestUtils {
  ...
  public static Response verifyPostResponse(
  ...
  public static Response verifyPostResponseWithQueryParams(
      String url,
      String body,
  ...
  public static Response verifyPut(
      String url, JsonObject body, String expectedContentType, int expectedCode) {
    return verifyPut(url, body.encodePrettily(), expectedContentType, expectedCode);
  }

  public static Response verifyPut(
      String url, String body, String expectedContentType, int expectedCode) {
    return verifyPut(
        url,
        body,
  ...
  public static Response verifyPatch(
      String url, String body, String expectedContentType, int expectedCode) {
    return verifyPatch(
        url,
        body,
  ...
  public static Response verifyGet(
      String url, String expectedContentType, int expectedCode, String tenant) {
    Headers headers = prepareHeaders(new Header(OKAPI_HEADER_TENANT, tenant));
    return verifyGet(url, headers, expectedContentType, expectedCode);
  }

  public static Response verifyGet(
      String url, Headers headers, String expectedContentType, int expectedCode) {
  ...
  public static Response verifyDeleteResponse(
      String url, String expectedContentType, int expectedCode) {
    Headers headers = prepareHeaders(NON_EXIST_CONFIG_X_OKAPI_TENANT);
  ...
  public static void checkPreventProtectedFieldsModificationRule(
      String path, JsonObject compPO, Map<String, Object> updatedFields) {
    ...
    Errors errors =
        verifyPut(
                String.format(path, compPO.getString("id")),
                compPOJson,
                "",
