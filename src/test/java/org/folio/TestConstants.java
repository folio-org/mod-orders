...
public final class TestConstants {
  ...
  public static final String ID_FOR_PIECES_INTERNAL_SERVER_ERROR =
      "93c5bb58-9429-4fa7-b06d-a829bdf16813";
  public static final String PO_ID_GET_LINES_INTERNAL_SERVER_ERROR =
      "bad500bb-bbbb-500b-bbbb-bbbbbbbbbbbb";
  public static final String PO_ID_PENDING_STATUS_WITH_PO_LINES =
      "e5ae4afd-3fa9-494e-a972-f541df9b877e";
  public static final String PO_ID_PENDING_STATUS_WITHOUT_PO_LINES =
      "50fb922c-3fa9-494e-a972-f2801f1b9fd1";
  public static final String PO_ID_OPEN_STATUS = "c1465131-ed35-4308-872c-d7cdf0afc5f7";
  public static final String PO_ID_OPEN_STATUS_CONDITIONAL_PROTECTED_FIELDS =
      "c1465131-ed35-4308-872c-d7cdf0afc5f8";
  ...
  public static final String PO_LINE_ID_WRONG_EXPENSE_CLASS =
      "bd8f1901-c768-4bb1-b650-8c12c5f42fd8";
  ...
  public static final String INSTANCE_TYPE_CONTAINS_CODE_AS_INSTANCE_STATUS_TENANT =
      "hasCodeLikeInstanceStatus";
  ...
  public static final Header INSTANCE_TYPE_CONTAINS_CODE_AS_INSTANCE_STATUS_TENANT_HEADER =
      new Header(OKAPI_HEADER_TENANT, INSTANCE_TYPE_CONTAINS_CODE_AS_INSTANCE_STATUS_TENANT);
  public static final Header NON_EXIST_INSTANCE_STATUS_TENANT_HEADER =
      new Header(OKAPI_HEADER_TENANT, NON_EXIST_INSTANCE_STATUS_TENANT);
  public static final Header NON_EXIST_INSTANCE_TYPE_TENANT_HEADER =
      new Header(OKAPI_HEADER_TENANT, NON_EXIST_INSTANCE_TYPE_TENANT);
  public static final Header NON_EXIST_LOAN_TYPE_TENANT_HEADER =
      new Header(OKAPI_HEADER_TENANT, NON_EXIST_LOAN_TYPE_TENANT);
  public static final Header NON_EXIST_CONFIG_X_OKAPI_TENANT =
      new Header(OKAPI_HEADER_TENANT, "ordersimpltest");
  public static final Header X_OKAPI_USER_ID =
      new Header(OKAPI_USERID_HEADER, "440c89e3-7f6c-578a-9ea8-310dad23605e");
  public static final Header ALL_DESIRED_ACQ_PERMISSIONS_HEADER =
      new Header(
          OKAPI_HEADER_PERMISSIONS,
          new JsonArray(AcqDesiredPermissions.getValuesExceptBypass()).encode());
  public static final Header X_OKAPI_USER_ID_WITH_ACQ_UNITS =
      new Header(OKAPI_USERID_HEADER, USER_ID_ASSIGNED_TO_ACQ_UNITS);
  public static final Header X_OKAPI_TOKEN =
      new Header(
          OKAPI_HEADER_TOKEN,
          "eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJkaWt1X2FkbWluIiwidXNlcl9pZCI6ImJmZTI2MjM0LTMzNjktNTdhYS05ZjhhLWU2ZWVhY2M0YTgzYiIsImlhdCI6MTU4MzE1Nzg5OCwidGVuYW50IjoiZGlrdSJ9.Mk7u4KaCywSuYtBgCT44oGcVC0C8jUMY9KjsUnug48I");
  public static final Header EXIST_CONFIG_X_OKAPI_TENANT_LIMIT_10 =
      new Header(OKAPI_HEADER_TENANT, "test_diku_limit_10");
  public static final Header EXIST_CONFIG_X_OKAPI_TENANT_LIMIT_10_CLAIMS =
      new Header(OKAPI_HEADER_TENANT, "test_diku_limit_10_claims");
  public static final Header EXIST_CONFIG_X_OKAPI_TENANT_LIMIT_1 =
      new Header(OKAPI_HEADER_TENANT, "test_diku_limit_1");
  public static final Header EXIST_CONFIG_X_OKAPI_TENANT_ECS =
      new Header(OKAPI_HEADER_TENANT, "consortium");
  public static final Header INVALID_CONFIG_X_OKAPI_TENANT =
      new Header(OKAPI_HEADER_TENANT, "invalid_config");
  public static final Header EMPTY_CONFIG_X_OKAPI_TENANT =
      new Header(OKAPI_HEADER_TENANT, EMPTY_CONFIG_TENANT);
  ...
  public static final String ID_FOR_TEMPLATE_NAME_ALREADY_EXISTS =
      "cd0619fb-a628-4d90-be41-df8943e97768";
