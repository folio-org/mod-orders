...
public class VertxFutureRepeaterTest {
  ...
  private static final Future<String> a = succeededFuture("a");
  private static final Future<String> b = succeededFuture("b");
  ...
  private static final Future<String> fail1 = failedFuture(new Fail1());
  private static final Future<String> fail2 = failedFuture(new Fail2());
