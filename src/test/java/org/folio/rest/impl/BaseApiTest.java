...
public class BaseApiTest {
  ...
  @Mock Handler<AsyncResult<Response>> asyncResultHandler;
  @Captor private ArgumentCaptor<Future<Response>> asyncResultCaptor;
  ...
  void testHandleErrorResponse() {
    ...
    doNothing().when(asyncResultHandler).handle(any());
